import { CodeContent, HeadingContent, ListContent, ListItemContent, MathContent, Content, QuoteContent, RootContent, TableContent } from '../base/content'
...
export function buildTable (cells: any) {
